//! ```text
//! Autogenerated: '.cache/fiat-crypto/src/ExtractionOCaml/fiat_crypto' word-by-word-montgomery --lang Rust --no-prefix-fiat --no-field-element-typedefs --public-type-case PascalCase --private-type-case PascalCase --output '.work/decaf-fields/rust/fq.rs' fq 32 8444461749428370424248824938781546531375899335154063827935233455917409239041
...
///   out2: [0x0 ~> 0x1]
/// ```
pub const fn fq_addcarryx_u32(out1: &mut u32, out2: &mut FqU1, arg1: FqU1, arg2: u32, arg3: u32) {
...
///   out2: [0x0 ~> 0x1]
/// ```
pub const fn fq_subborrowx_u32(out1: &mut u32, out2: &mut FqU1, arg1: FqU1, arg2: u32, arg3: u32) {
...
///   out2: [0x0 ~> 0xffffffff]
/// ```
pub const fn fq_mulx_u32(out1: &mut u32, out2: &mut u32, arg1: u32, arg2: u32) {
...
///   out1: [0x0 ~> 0xffffffff]
/// ```
pub const fn fq_cmovznz_u32(out1: &mut u32, arg1: FqU1, arg2: u32, arg3: u32) {
  let x1: FqU1 = (!(!arg1));
  let x2: u32 = ((((((0x0 as FqI2) - (x1 as FqI2)) as FqI1) as i64) & (0xffffffff as i64)) as u32);
...
/// ```
pub const fn fq_mul(out1: &mut [u32; 8], arg1: &[u32; 8], arg2: &[u32; 8]) {
  let x1: u32 = arg1[1];
  let x2: u32 = arg1[2];
  let x3: u32 = arg1[3];
  let x4: u32 = arg1[4];
...
///   out1: [[0x0 ~> 0xffffffff], [0x0 ~> 0xffffffff], [0x0 ~> 0xffffffff], [0x0 ~> 0xffffffff], [0x0 ~> 0xffffffff], [0x0 ~> 0xffffffff], [0x0 ~> 0xffffffff], [0x0 ~> 0xffffffff]]
/// ```
pub const fn fq_square(out1: &mut [u32; 8], arg1: &[u32; 8]) {
  let x1: u32 = arg1[1];
  let x2: u32 = arg1[2];
  let x3: u32 = arg1[3];
  let x4: u32 = arg1[4];
...
///   out1: [[0x0 ~> 0xffffffff], [0x0 ~> 0xffffffff], [0x0 ~> 0xffffffff], [0x0 ~> 0xffffffff], [0x0 ~> 0xffffffff], [0x0 ~> 0xffffffff], [0x0 ~> 0xffffffff], [0x0 ~> 0xffffffff]]
/// ```
pub const fn fq_add(out1: &mut [u32; 8], arg1: &[u32; 8], arg2: &[u32; 8]) {
  let mut x1: u32 = 0;
  let mut x2: FqU1 = 0;
...
///   out1: [[0x0 ~> 0xffffffff], [0x0 ~> 0xffffffff], [0x0 ~> 0xffffffff], [0x0 ~> 0xffffffff], [0x0 ~> 0xffffffff], [0x0 ~> 0xffffffff], [0x0 ~> 0xffffffff], [0x0 ~> 0xffffffff]]
/// ```
pub const fn fq_sub(out1: &mut [u32; 8], arg1: &[u32; 8], arg2: &[u32; 8]) {
  let mut x1: u32 = 0;
  let mut x2: FqU1 = 0;
  ...
  let mut x18: u32 = 0;
  let mut x19: FqU1 = 0;
  fq_addcarryx_u32(&mut x18, &mut x19, 0x0, x1, (((x17 & (0x1 as u32)) as FqU1) as u32));
  let mut x20: u32 = 0;
  let mut x21: FqU1 = 0;
...
///   out1: [[0x0 ~> 0xffffffff], [0x0 ~> 0xffffffff], [0x0 ~> 0xffffffff], [0x0 ~> 0xffffffff], [0x0 ~> 0xffffffff], [0x0 ~> 0xffffffff], [0x0 ~> 0xffffffff], [0x0 ~> 0xffffffff]]
/// ```
pub const fn fq_opp(out1: &mut [u32; 8], arg1: &[u32; 8]) {
  let mut x1: u32 = 0;
  let mut x2: FqU1 = 0;
...
///   out1: [[0x0 ~> 0xffffffff], [0x0 ~> 0xffffffff], [0x0 ~> 0xffffffff], [0x0 ~> 0xffffffff], [0x0 ~> 0xffffffff], [0x0 ~> 0xffffffff], [0x0 ~> 0xffffffff], [0x0 ~> 0xffffffff]]
/// ```
pub const fn fq_from_montgomery(out1: &mut [u32; 8], arg1: &[u32; 8]) {
  let x1: u32 = arg1[0];
  let mut x2: u32 = 0;
  let mut x3: u32 = 0;
  ...
  let mut x102: u32 = 0;
  let mut x103: FqU1 = 0;
  fq_addcarryx_u32(&mut x102, &mut x103, x101, ((x59 as u32) + ((x45 as u32) + ((x29 as u32) + x5))), x86);
  let mut x104: u32 = 0;
  let mut x105: FqU1 = 0;
  ...
  let mut x160: u32 = 0;
  let mut x161: FqU1 = 0;
  fq_addcarryx_u32(&mut x160, &mut x161, x159, ((x117 as u32) + ((x103 as u32) + ((x87 as u32) + x63))), x144);
  let mut x162: u32 = 0;
  let mut x163: FqU1 = 0;
  ...
  let mut x218: u32 = 0;
  let mut x219: FqU1 = 0;
  fq_addcarryx_u32(&mut x218, &mut x219, x217, ((x175 as u32) + ((x161 as u32) + ((x145 as u32) + x121))), x202);
  let mut x220: u32 = 0;
  let mut x221: FqU1 = 0;
  ...
  let mut x276: u32 = 0;
  let mut x277: FqU1 = 0;
  fq_addcarryx_u32(&mut x276, &mut x277, x275, ((x233 as u32) + ((x219 as u32) + ((x203 as u32) + x179))), x260);
  let mut x278: u32 = 0;
  let mut x279: FqU1 = 0;
  ...
  let mut x334: u32 = 0;
  let mut x335: FqU1 = 0;
  fq_addcarryx_u32(&mut x334, &mut x335, x333, ((x291 as u32) + ((x277 as u32) + ((x261 as u32) + x237))), x318);
  let mut x336: u32 = 0;
  let mut x337: FqU1 = 0;
  ...
  let mut x392: u32 = 0;
  let mut x393: FqU1 = 0;
  fq_addcarryx_u32(&mut x392, &mut x393, x391, ((x349 as u32) + ((x335 as u32) + ((x319 as u32) + x295))), x376);
  let mut x394: u32 = 0;
  let mut x395: FqU1 = 0;
  ...
  let mut x450: u32 = 0;
  let mut x451: FqU1 = 0;
  fq_addcarryx_u32(&mut x450, &mut x451, x449, ((x407 as u32) + ((x393 as u32) + ((x377 as u32) + x353))), x434);
...
///   out1: [[0x0 ~> 0xffffffff], [0x0 ~> 0xffffffff], [0x0 ~> 0xffffffff], [0x0 ~> 0xffffffff], [0x0 ~> 0xffffffff], [0x0 ~> 0xffffffff], [0x0 ~> 0xffffffff], [0x0 ~> 0xffffffff]]
/// ```
pub const fn fq_to_montgomery(out1: &mut [u32; 8], arg1: &[u32; 8]) {
  let x1: u32 = arg1[1];
  let x2: u32 = arg1[2];
  let x3: u32 = arg1[3];
  let x4: u32 = arg1[4];
  ...
  let mut x127: u32 = 0;
  let mut x128: FqU1 = 0;
  fq_addcarryx_u32(&mut x127, &mut x128, x126, (((x82 as u32) + ((x38 as u32) + x10)) + ((x66 as u32) + x42)), x111);
  let mut x129: u32 = 0;
  let mut x130: u32 = 0;
  ...
  let mut x217: u32 = 0;
  let mut x218: FqU1 = 0;
  fq_addcarryx_u32(&mut x217, &mut x218, x216, (((x172 as u32) + ((x128 as u32) + ((x112 as u32) + x84))) + ((x156 as u32) + x132)), x201);
  let mut x219: u32 = 0;
  let mut x220: u32 = 0;
  ...
  let mut x307: u32 = 0;
  let mut x308: FqU1 = 0;
  fq_addcarryx_u32(&mut x307, &mut x308, x306, (((x262 as u32) + ((x218 as u32) + ((x202 as u32) + x174))) + ((x246 as u32) + x222)), x291);
  let mut x309: u32 = 0;
  let mut x310: u32 = 0;
  ...
  let mut x397: u32 = 0;
  let mut x398: FqU1 = 0;
  fq_addcarryx_u32(&mut x397, &mut x398, x396, (((x352 as u32) + ((x308 as u32) + ((x292 as u32) + x264))) + ((x336 as u32) + x312)), x381);
  let mut x399: u32 = 0;
  let mut x400: u32 = 0;
  ...
  let mut x487: u32 = 0;
  let mut x488: FqU1 = 0;
  fq_addcarryx_u32(&mut x487, &mut x488, x486, (((x442 as u32) + ((x398 as u32) + ((x382 as u32) + x354))) + ((x426 as u32) + x402)), x471);
  let mut x489: u32 = 0;
  let mut x490: u32 = 0;
  ...
  let mut x577: u32 = 0;
  let mut x578: FqU1 = 0;
  fq_addcarryx_u32(&mut x577, &mut x578, x576, (((x532 as u32) + ((x488 as u32) + ((x472 as u32) + x444))) + ((x516 as u32) + x492)), x561);
  let mut x579: u32 = 0;
  let mut x580: u32 = 0;
  ...
  let mut x667: u32 = 0;
  let mut x668: FqU1 = 0;
  fq_addcarryx_u32(&mut x667, &mut x668, x666, (((x622 as u32) + ((x578 as u32) + ((x562 as u32) + x534))) + ((x606 as u32) + x582)), x651);
  let mut x669: u32 = 0;
  let mut x670: u32 = 0;
  ...
  let x713: u32 = (((x712 as u32) + ((x668 as u32) + ((x652 as u32) + x624))) + ((x696 as u32) + x672));
  let mut x714: u32 = 0;
  let mut x715: FqU1 = 0;
...
///   out1: [0x0 ~> 0xffffffff]
/// ```
pub const fn fq_nonzero(out1: &mut u32, arg1: &[u32; 8]) {
...
///   out1: [[0x0 ~> 0xffffffff], [0x0 ~> 0xffffffff], [0x0 ~> 0xffffffff], [0x0 ~> 0xffffffff], [0x0 ~> 0xffffffff], [0x0 ~> 0xffffffff], [0x0 ~> 0xffffffff], [0x0 ~> 0xffffffff]]
/// ```
pub const fn fq_selectznz(out1: &mut [u32; 8], arg1: FqU1, arg2: &[u32; 8], arg3: &[u32; 8]) {
  let mut x1: u32 = 0;
...
/// ```
pub const fn fq_to_bytes(out1: &mut [u8; 32], arg1: &[u32; 8]) {
  let x1: u32 = arg1[7];
  let x2: u32 = arg1[6];
  let x3: u32 = arg1[5];
  let x4: u32 = arg1[4];
...
/// ```
pub const fn fq_from_bytes(out1: &mut [u32; 8], arg1: &[u8; 32]) {
...
///   out1: [[0x0 ~> 0xffffffff], [0x0 ~> 0xffffffff], [0x0 ~> 0xffffffff], [0x0 ~> 0xffffffff], [0x0 ~> 0xffffffff], [0x0 ~> 0xffffffff], [0x0 ~> 0xffffffff], [0x0 ~> 0xffffffff]]
/// ```
pub const fn fq_set_one(out1: &mut [u32; 8]) {
  out1[0] = 0xfffffff3;
  out1[1] = 0x7d1c7fff;
  out1[2] = 0x6ffffff2;
  out1[3] = 0x7257f50f;
...
/// ```
pub const fn fq_msat(out1: &mut [u32; 9]) {
  out1[0] = (0x1 as u32);
  out1[1] = 0xa118000;
  out1[2] = 0xd0000001;
  out1[3] = 0x59aa76fe;
...
///   out1: [[0x0 ~> 0xffffffff], [0x0 ~> 0xffffffff], [0x0 ~> 0xffffffff], [0x0 ~> 0xffffffff], [0x0 ~> 0xffffffff], [0x0 ~> 0xffffffff], [0x0 ~> 0xffffffff], [0x0 ~> 0xffffffff]]
/// ```
pub const fn fq_divstep_precomp(out1: &mut [u32; 8]) {
  out1[0] = 0xb566adb8;
  out1[1] = 0x71a88a38;
  out1[2] = 0xd16832cf;
  out1[3] = 0xedffbafe;
...
/// ```
pub const fn fq_divstep(out1: &mut u32, out2: &mut [u32; 9], out3: &mut [u32; 9], out4: &mut [u32; 8], out5: &mut [u32; 8], arg1: u32, arg2: &[u32; 9], arg3: &[u32; 9], arg4: &[u32; 8], arg5: &[u32; 8]) {
  let mut x1: u32 = 0;
  let mut x2: FqU1 = 0;
  ...
  let mut x110: u32 = 0;
  let mut x111: FqU1 = 0;
  fq_addcarryx_u32(&mut x110, &mut x111, 0x0, x93, (((x109 & (0x1 as u32)) as FqU1) as u32));
  let mut x112: u32 = 0;
  let mut x113: FqU1 = 0;
